                            ...
                            <tbody>
                                @forelse($data as $table)
                                    <tr>
										...
										<td >{{ $table->order_coin }}</td>
										<td >{{ $table->order_category }}</td>
										<td >{{ $table->order_side }}</td>
										<td >{{ $table->order_type }}</td>
										<td >{{ $table->order_qty }}</td>
										<td >{{ $table->order_price }}</td>
										<td >{{ $table->order_reference }}</td>
